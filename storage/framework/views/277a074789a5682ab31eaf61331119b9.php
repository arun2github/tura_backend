...
<div class="header">
    <div class="government-seal">
        <?php if($logo_path && file_exists($logo_path)): ?>
            <img src="<?php echo e($logo_path); ?>" style="width:70px;height:70px;border-radius:50%;object-fit:cover;border:2px solid #1a4a72;">
        <?php else: ?>
    ...
    <div style="font-size:15px;font-weight:600;margin-top:6px;"><?php echo e($job_title); ?></div>
</div>
...
<div class="content-wrapper">
    <div class="photo-section">
        <div class="photo-frame">
            <?php if($photo_base64): ?>
                <img src="data:image/jpeg;base64,<?php echo e($photo_base64); ?>" class="candidate-photo">
            <?php else: ?>
    ...
    <div class="details-section">
        <table class="details-table">
            ...
            <tr><td class="label-cell">Roll Number:</td><td class="value-cell"><?php echo e($roll_number); ?></td></tr>
            <tr><td class="label-cell">Application ID:</td><td class="value-cell"><?php echo e($application_id); ?></td></tr>
            <tr><td class="label-cell">Admit Card No:</td><td class="value-cell"><?php echo e($admit_no); ?></td></tr>
            <?php if($date_of_birth): ?><tr><td class="label-cell">Date of Birth:</td><td><?php echo e($date_of_birth); ?></td></tr><?php endif; ?>
            <?php if($gender): ?><tr><td class="label-cell">Gender:</td><td><?php echo e(strtoupper($gender)); ?></td></tr><?php endif; ?>
            <?php if($category): ?><tr><td class="label-cell">Category:</td><td><?php echo e(strtoupper($category)); ?></td></tr><?php endif; ?>
            <tr><td class="label-cell">Examination Date:</td><td><?php echo e($exam_date); ?></td></tr>
            <tr><td class="label-cell">Reporting Time:</td><td><?php echo e($reporting_time); ?></td></tr>
            <tr><td class="label-cell">Exam Time:</td><td><?php echo e($exam_time); ?></td></tr>
        </table>
    </div>
</div>
...
<?php /**PATH C:\Users\imaru\Desktop\dev\laravel_turamunicipal\resources\views/pdf/admit_card.blade.php ENDPATH**/ ?>